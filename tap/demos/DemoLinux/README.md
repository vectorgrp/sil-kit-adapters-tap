...
You can also run the same test set with ``CANoe4SW SE (Linux)``. In ``tap/demos/CANoe4SW_SE/run.sh`` you should adapt ``default_canoe4sw_se_install_dir`` to the path of your ``CANoe4SW SE`` installation in your WSL2. Afterwards you can execute ``tap/demos/CANoe4SW_SE/run.sh`` in your WSL2. The test cases are executed automatically and you should see a short test report in your terminal after execution.
